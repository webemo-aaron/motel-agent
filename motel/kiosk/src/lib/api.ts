...
export const api = {
  ...
  kioskBook: (payload: { guest_name: string; check_in: string; check_out: string; room_id: string; rate_per_night?: number; email?: string; phone?: string; party_size?: number; stay_class?: "short"|"medium"|"long"; weekly_housekeeping_cadence_days?: number }) => post<any>("/kiosk/book", payload),
